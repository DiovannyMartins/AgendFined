-- Fix the PL/pgSQL ambiguity between the subscriptions.business_id column
-- and the function's business_id return column.
...
begin
  ...
  where s.id = p_subscription_id
    ...
    and s.mp_preapproval_id = p_mp_preapproval_id
  for update;
