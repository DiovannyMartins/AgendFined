...
- O teste da seção confirma Grátis atual, PROFISSIONAL, `R$ 1/mês`, benefícios e CTA de assinatura para um negócio Grátis.
...
3. Confirme que Grátis aparece como atual e PROFISSIONAL aparece como opção de assinatura com `R$ 1/mês`, recursos Pro e botão `Assinar PROFISSIONAL`.
